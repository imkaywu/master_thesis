...
%% multi-row and multi-column table 
...
\tikzstyle{data} = [rectangle, rounded corners, minimum width=3cm, minimum height=1cm, text centered, text width=3cm, draw=black, fill=blue!30]
\tikzstyle{data_nonfixed} = [rectangle, rounded corners, minimum width=1.5cm, minimum height=1cm, text centered, draw=black, fill=blue!30]
...
\tikzstyle{process_nonfixed} = [rectangle, minimum width=1.5cm, minimum height=1cm, text centered, draw=black, fill=green!30]
\tikzstyle{model} = [ellipse, minimum width=3cm, minimum height=1cm, text centered, text width=2cm, draw=black, fill=red!20]
\tikzstyle{model_nonfixed} = [ellipse, minimum width=1.5cm, minimum height=1cm, text centered, draw=black, fill=red!20]
...
\title{Development and Application of a Description-Based Interface for 3D Reconstruction}
...
%	 2.5 Lay summary (mandatory - maximum 150 words)
\include{laysummary}
\cleardoublepage
