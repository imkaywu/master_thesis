...
% \setlength{\tabcolsep}{3pt} % table column spacing for the whole doc
...
\begin{exampleblock}{}
\begin{itemize}
\item comparable accuracy or completeness
\item less accurate description trigger the same algorithm as the accurate one.
\end{itemize}
\end{exampleblock}
