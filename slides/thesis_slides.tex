...
\begin{alertblock}{Challenges}
  \begin{itemize}
    ...
    \item \textbf{Parameters}: not interpretable, meaningful, or conceptually estimatible, vary from algorithm to algorithm.
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{images/mapping_1.pdf}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{images/mapping_2.pdf}
\end{figure}
