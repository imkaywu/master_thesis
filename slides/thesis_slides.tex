...
\begin{exampleblock}{Strengths}
  \begin{itemize}
    ...
    \item \textbf{Approach}: choose an algorithm based on mapping.
  \end{itemize}
\end{exampleblock}
...
\begin{table}
  ...
  Lightness & \textit{Diffuse reflectance} & \raisebox{-.5\height}{\includegraphics[width=0.3\textwidth]{mapping/setup/alb0}}\\
  Specularity & \textit{Fresnel reflectance} & \raisebox{-.5\height}{\includegraphics[width=0.3\textwidth]{mapping/setup/spec0}}\\
  Roughness & \textit{Distribution of facet slope} & \raisebox{-.5\height}{\includegraphics[width=0.3\textwidth]{mapping/setup/rough0}}\\
