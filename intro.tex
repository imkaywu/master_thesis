...
% 3D model
\node (def) [data, left of=abstract, xshift=-3cm, yshift=4cm)] {Definition};
...
\item A model of 3D reconstruction that can describe 3D reconstruction problem distincitvely without loss of generability;
\item An abstraction of 3D reconstruction that maps problem model to a suite of algorithms.
\end{itemize}
