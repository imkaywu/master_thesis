...
We propose a scenario to further emphasize and justify the motivation: Daisy is a fan of [], and she wants to personalize a coffee mug with the [] on the surface. She is a student major in archeology with limited computer science background. There is a laser scanner in her department that has been used to scan archeological [stuff?]. She managed to book the equipment for a single session and with the help of the technicians, she managed to get a 3D scan of the []. However, the result is not optimal. She went on to the internet and came across a Youtube tutorial on getting 3D models from images using open source softwares (VisualSfM and PMVS). She followed the steps in the tutorial, take pictures using a DSLR camera from multiple viewpoints, and reconstruct a model using the softwares. The result is way too noisy to meet her standard. One of her friends, Ben, who is a computer science researcher working on 3D reconstruction techniques, introduced her to a technique called Photometric Stereo. Ben helped her capture images and run an algorithm he had developed to get the result she was happy with. Though she got her mug personalized, the process would not have been possible without the help of lab technicians and her friend Ben, and it took way more tries and comparisons before she can reach a decision. She was hoping that there could be an approach which tells her one of the best possible algorithms without requiring her going through all the hussles, and does so without her bugging her friends all the time.
