...
\subsubsection{Reflectance: diffuse/mixed model}
...
\subsubsection{Reflectance: Lambertian model} % Lambertian PS: uniform reflectance
...
\subsubsection{Reflectance: Non-Lambertian model}
