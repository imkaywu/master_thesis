...
\end{tabular}
\caption{Shape estimation results with varied mean and median values. The algorithm is less sensitive to large mean or median values, while more sensitive to the difference between the mean and median values.}
