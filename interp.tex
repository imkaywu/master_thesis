...
\begin{itemize}
\item\textbf{1. Can the proof of concept interpreter return one of the best-suited algorithms that achieves a successful reconstruction given the correct description?}
% \item\textbf{2. Can a unspecified description give a decent reconstruction result (baseline result)?}
\item\textbf{2. Can a better description give a better reconstruction result than a worse description?}
\item\textbf{3. Can a wrong description give a poor reconstruction result?}
\end{itemize}
...
\bottomrule
\end{tabular}
\caption{The rerepsentatives of the four classes of objects used for evaluation. Problem conditions and interpreted algorithm of the real-world objects. The description matches the problem condition of corresponding object. The last column shows the algorithm returned by the mapping, from which the interpreter will select one appropriate algorithm.}
...
% \toprule
% Cond \# & Object & Desc \# & Interp Algo. & Result & Baseline \\
% \midrule
% \multirow{2}{*}{1} & Bust & & \multirow{2}{*}{GSL} & 
% \raisebox{-.5\height}{\includegraphics[width=0.15\textwidth]{interp/synth_interp/beethoven_sl}} &
% \raisebox{-.5\height}{\includegraphics[width=0.15\textwidth]{interp/synth_interp/beethoven_vh}}\\
...
% \multirow{2}{*}{2} & Vase0 & & \multirow{2}{*}{EPS} &
% \raisebox{-.5\height}{\includegraphics[width=0.15\textwidth]{interp/synth_interp/vase0_ps}} &
% \raisebox{-.5\height}{\includegraphics[width=0.15\textwidth]{interp/synth_interp/vase0_vh}}\\
...
% \multirow{2}{*}{3} & Barrel & & \multirow{2}{*}{GSL} &
% \raisebox{-.5\height}{\includegraphics[width=0.15\textwidth]{interp/synth_interp/barrel_sl}} &
% \raisebox{-.5\height}{\includegraphics[width=0.15\textwidth]{interp/synth_interp/barrel_vh}}\\
...
% \multirow{2}{*}{4} & Vase1 & & \multirow{2}{*}{PMVS} &
% \raisebox{-.5\height}{\includegraphics[width=0.15\textwidth]{interp/synth_interp/vase1_mvs}} &
% \raisebox{-.5\height}{\includegraphics[width=0.15\textwidth]{interp/synth_interp/vase1_vh}}\\
...
In this section, we evaluate whether the interpreter can return a better reconstruction result given a better description of problem condition. We evaluate the performance of the interpreter using both synthetic and real-world objects.

For each object, we set the parameter of one property incorrect, and see if the result gets worse. Each time, $\text{Prop}_i$ is incorrectly described in $\text{Desc}_i$.
\begin{figure*}[!htbp]
\centering
...
\bottomrule
\end{tabular}
\caption{Evaluation 2: better description, better result}
\label{fig:eval_21}
\end{figure*}
