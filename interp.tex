...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.4\textwidth]{img/interp/ui/ui_sphere_1.PNG} &
\includegraphics[width=0.4\textwidth]{img/interp/ui/ui_teapot.PNG} \\
(a). synthetic sphere & (b). synthetic object \\
\end{tabular}
\caption{(a) and (b) shows the synthetic object rendered using the problem condition of object `bust' and `statue'. [images need to be changed]}
