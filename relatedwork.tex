...
\midrule
Shape from Stereo & 
\raisebox{-0.75\height}{\includegraphics[width=0.2\textwidth]{interp/setup/mvs_setup.PNG}} &
\raisebox{-0.75\height}{\includegraphics[width=0.2\textwidth]{interp/setup/sl_setup.png}} &
Stereo correspondence &
Texture, Albedo, Specular \\
Shape from Intensity & 
\raisebox{-.75\height}{\includegraphics[width=0.2\textwidth]{relatedwork/sfs.pdf}} &
\raisebox{-.75\height}{\includegraphics[width=0.2\textwidth]{relatedwork/ps.pdf}} &
Shading variation &
Albedo, Specular, Geometry \\
Shape from Silhouette &
\raisebox{-.75\height}{\includegraphics[width=0.2\textwidth]{relatedwork/vh.jpg}} &
\raisebox{-.75\height}{\includegraphics[width=0.2\textwidth]{relatedwork/vh1.jpg}} &
Silhouette &
Geometry\\
\end{tabular}
...
\end{figure}
% Top left image is from ``Multi-View Stereo: A Tutorial'', \textcopyright 2015 Furukawa and Hernandez, by permission. Top right image from . 
